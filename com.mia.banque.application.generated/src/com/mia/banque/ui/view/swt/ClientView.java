...
public class ClientView extends Shell implements IClientView {
	...
	private void createContents(){
		...
		NomField.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		PrenomField.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		AdresseField.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		for (final com.mia.banque.model.ICompte elt : this.model.getListComptes()) {
